...
void init_motor_pwm_tim(void)
{
	...
	pwm_period = MOTOR_PWM_PERIOD;  //周期1/25Khz
	...
	TIM_OCInitStructure.TIM_OCPolarity = TIM_OCPolarity_Low;  //TIM_CNT < TIM_CCR1 低电平有效 A4931 ENA 低电平有效 高电平关掉mosfet
