 ...
 * V2.1   tianqinglin	 2017.02.20  修改文件
 *****************************************************************************
 *****************************************************************************/
#ifndef __CFG_H__
#define __CFG_H__
...
/* software version*/
#define  software_verison  0x0220;   // 0x02 = 2 0x20 =21 v2.20 通信协议更新，v2.0不可控之后的车
...
/**FL45BLW18W-18V-3020B**/
//#define MOTOR_KI  39.3f /* measured in mNm/A 转矩常数*/
//#define MOTOR_KV  374.0f /* measured in rpm/V */
//#define MOTOR_R   1.2f /* measured in ohm */
...
#define D_WHEEL_ANGLE_FRONT 55		/* 前轮与轴线角度(度) 前轮轮子轴线(垂直于轮子)与小车前后轴线角度*/
...
/* ADC parameter */
#define BAT_V_ADC_GAIN			(3.3f / 256.0f / (3300.0f / (22000.0f + 3300.0f)))  //电池电压电阻分压系数 0.09885

#define CAP_V_ADC_GAIN			(3.3f / 256.0f / (5.1f / (249.0f + 5.1f)))    //充电电容电阻分压系数 0.64228
